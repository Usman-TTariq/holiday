        ...
        <div className="cloud-section relative py-10 bg-white h-[720px]">
            ...
            <div className="container relative">
                ...
                <div className="absolute top-0 left-0 w-full">
                    ...
                    <div ref={textRef} className="absolute z-20 top-[45%] left-[50%] -translate-x-1/2 -translate-y-1/2 font-childhood w-full text-white text-center text-[54px] leading-[1]">Ready to Publish a Children's Book?<br />Our Experts Handle Everything
