      ...
      <div className="portfolio pt-10 relative z-20">
        ...
        >
          {duplicatedImages.map((src, i) => (
            <SwiperSlide key={i}>
              <img className="book-img two-active transition-all duration-300 ease-in-out hover:scale-110 hover:drop-shadow-2xl hover:drop-shadow-yellow-400/50 cursor-pointer" src={src} alt="book" />
            </SwiperSlide>
          ))}
        </Swiper>
      </div>
