    ...
    return (
        <div className="relative bg-white py-10">
            ...
            <div className="container">
                <div className="font-childhood text-black text-[60px] text-center">Publish Your Children’s Book Quickly and Easily</div>
                <div className="text-black text-[16px] text-center px-[100px]">Need your children’s book published fast? Our streamlined self-publishing process gets your story ready for readers quickly—on any platform you choose.</div>
